...
upload_files() {
    ...
    rsync -avz --delete -e "ssh -p 30002" "${LOCAL_KK_DIR}builtin/playbooks/" root@139.198.121.174:"${CAPKK_ARTIFACTS_PVC}/capkk/playbooks/"
    rsync -avz --delete -e "ssh -p 30002" "${LOCAL_KK_DIR}builtin/roles/" root@139.198.121.174:"${CAPKK_ARTIFACTS_PVC}/capkk/roles/"
    echo ""
}
...
update_template() {
    ...
    ssh -p 30002 root@139.198.121.174 "rm -r ${CAPKK_ARTIFACTS_PVC}runtime/ || true"
